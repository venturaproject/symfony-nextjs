            ...
            <table className="min-w-full bg-white border border-gray-300">
                <thead>
                    <tr className="bg-gray-100">
                        ...
                        <th className="py-2 px-4 border-b">{t('Fecha de Creación')}</th>
                ...
                <tbody>
                    {currentProducts.map((product) => (
                        <tr key={product.id}>
                            ...
                            <td className="py-2 px-4 border-b">{product.created_at ? new Date(product.created_at).toLocaleDateString() : t('no_disponible')}</td>
